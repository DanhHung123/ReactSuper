import { useAddPostMutation, useGetPostQuery, useUpdatePostMutation } from "pages/blog/blo.service"
...
export default function CreatePost() {
  const [formData, setFormData] = useState<Omit<Post, 'id'> | Post>(initState)
